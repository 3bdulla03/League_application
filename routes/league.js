...
router.get('/:leagueId/teams/:teamId/players/:playerId', playerCtrl.player_show_get)

router.delete('/:leagueId/teams/:teamId/players/:playerId', playerCtrl.player_delete_destroy)

router.get('/:leagueId/teams/:teamId/players/:playerId/edit',playerCtrl.player_show_edit)
router.put('/:leagueId/teams/:teamId/players/:playerId', playerCtrl.player_update_put)
